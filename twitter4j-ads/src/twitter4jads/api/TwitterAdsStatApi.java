...
public interface TwitterAdsStatApi {
    ...
    BaseAdsListResponseIterable<TwitterActiveEntitiesEntity> fetchActiveEntities(String accountId, TwitterEntityType twitterEntity,
                                                                                 long startTime, long endTime) throws TwitterException;
